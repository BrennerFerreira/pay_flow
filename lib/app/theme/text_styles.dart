...
class AppTextStyles {
  ...
  static final titleOnPrimary = GoogleFonts.lexendDeca(
    fontSize: 20,
  ...
  static final titleBoldOnPrimary = GoogleFonts.lexendDeca(
    fontSize: 20,
    fontWeight: FontWeight.w600,
    color: AppColors.background,
  );
  ...
  static final buttonOnPrimary = GoogleFonts.inter(
    fontSize: 15,
    fontWeight: FontWeight.w400,
    color: AppColors.background,
  );
  ...
  static final buttonBoldOnPrimary = GoogleFonts.inter(
    fontSize: 15,
    fontWeight: FontWeight.w700,
    color: AppColors.background,
  );
  static final captionOnPrimary = GoogleFonts.lexendDeca(
    fontSize: 13,
    fontWeight: FontWeight.w400,
    color: AppColors.background,
  );
