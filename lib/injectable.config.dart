...
import 'modules/home/controllers/home_controller.dart' as _i22;
...
import 'modules/home/services/firebase_firestore_boleto_list_services.dart'
    as _i6;
import 'modules/home/services/i_boleto_list_services.dart' as _i11;
import 'modules/insert_boleto/controller/insert_boleto_controller.dart' as _i15;
...
import 'shared/auth/services/firebase_messaging_services.dart' as _i17;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i11.IBoletoListServices>(() =>
      _i12.BoletoListServices(get<_i6.FirebaseFirestoreBoletoListservices>()));
  gh.factory<_i13.ISaveBoletoServices>(() =>
  ...
  gh.factory<_i17.FirebaseMessaginServices>(
      () => _i17.FirebaseMessaginServices(get<_i9.FirebaseMessaging>()));
  gh.factory<_i18.GoogleServices>(
      () => _i18.GoogleServices(get<_i10.GoogleSignIn>()));
  gh.factory<_i19.IAuthServices>(() => _i20.AuthServices(
      ...
      get<_i17.FirebaseMessaginServices>()));
  gh.lazySingleton<_i21.AuthController>(
      () => _i21.AuthController(get<_i19.IAuthServices>()));
  gh.factory<_i22.HomePageController>(
      () => _i22.HomePageController(get<_i21.AuthController>()));
  return get;
}
